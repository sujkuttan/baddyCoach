...
def _get_gpu_batch_config(device: str) -> dict:
    ...
    tiers = [
        (12, {"yolo_chunk": 500, "yolo_batch": 32, "tracknet_chunk": 64, "rtmpose_chunk": 256, "bst_batch": 128}),
        (6,  {"yolo_chunk": 200, "yolo_batch": 16, "tracknet_chunk": 32, "rtmpose_chunk": 128, "bst_batch": 64}),
