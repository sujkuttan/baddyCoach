...
def _get_gpu_batch_config(device: str) -> dict:
    ...
    tiers = [
        (12, {"yolo_chunk": 200, "yolo_batch": 16, "tracknet_chunk": 32, "rtmpose_chunk": 128, "bst_batch": 128}),
        (6,  {"yolo_chunk": 100, "yolo_batch": 8,  "tracknet_chunk": 16, "rtmpose_chunk": 64,  "bst_batch": 64}),
        (2,  {"yolo_chunk": 50,  "yolo_batch": 4,  "tracknet_chunk": 8,  "rtmpose_chunk": 32,  "bst_batch": 32}),
        (0,  {"yolo_chunk": 25,  "yolo_batch": 2,  "tracknet_chunk": 4,  "rtmpose_chunk": 16,  "bst_batch": 16}),
    ]
